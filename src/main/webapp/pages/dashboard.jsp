			...
			<div
				...
				<div class="offcanvas-md offcanvas-end bg-body-tertiary"
					...
					<div class="offcanvas-header">
						<h5 class="offcanvas-title" id="sidebarMenuLabel">Exavalu Solutions</h5>
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div
					...
					<span class="text-primary">
						Welcome - <%out.print(user.getFirstName()+" "+user.getLastName()); %>
					</span>
					<div class="dropdown">
		<button class="btn btn-secondary dropdown-toggle" type="button"
			id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
			aria-expanded="false">
			<img src="<%=user.getImagePath()%>\<%=user.getSerialNumber()%>.jpg" style="height: 30px">
</button>
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			<a class="dropdown-item" href="EditUser">Edit User Profile</a> <a class="dropdown-item"
