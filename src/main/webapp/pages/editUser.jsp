...
if (user1 == null || !user1.isLoggedIn()) {
						...
						<div class="card mx-4 mx-md-5 shadow-5-strong"
							...
							<div class="card-body py-5 px-md-5">
								...
								<div class="row d-flex justify-content-center">
									<div class="col-lg-8">
										<h2 class="fw-bold mb-5">Edit User Details</h2>
										...
										<form action="UpdateUser" method="post">
											...
											<div class="form-outline">
												<span class="mb-2 text-primary"> Serial Number </span>
												<input type="text" id="form3Example2" class="form-control"
													name="Serial" value="<%=(user.getSerialNumber())%>" readonly> 
											</div>

											<!-- 2 column grid layout with text inputs for the first and last names -->
											<div class="row">
												<div class="col-md-6 mb-4">
												<span class="mb-2 text-primary"> First Name </span>
													<div class="form-outline">
												...
												<div class="col-md-6 mb-4">
												<span class="mb-2 text-primary"> Last Name </span>
													<div class="form-outline">
														<input type="text" id="form3Example2" class="form-control"
											...
											<div class="row">
												<div class="col-md-6 mb-4">
												<span class="mb-2 text-primary"> Email Address </span>
													<div class="form-outline">
														<input type="text" id="form3Example1" class="form-control"
															name="emailAddress" value="<%=(user.getEmailAddress())%>"> 
													</div>
												</div>
												
												<div class="col-md-6 mb-4">
												<span class="mb-2 text-primary"> Password </span>
													<div class="form-outline">
														<input type="text" id="form3Example2" class="form-control"
											...
											<div class="row">
												...
												<div class="col-md-6 mb-4">
												<span class="mb-2 text-primary"> Status </span>
													<div class="form-outline">
														<input class="form-check-input" type="checkbox" value="<%=user.getStatus() %>"
														name="status" <%if(user.getStatus()==1) { %> checked <%} %>>
